...
* BlazerID: prakashs
* Computer Architecture (CS 730)
* Course Project 
* ---------------
* ==> Writa a program to find:
*       1. No. of cache level
*       2. Cache size of each level
*       3. Block size
*       4. Associativity of cache level-1
*
* Note: 
* I have used -O optimization option to compile this program
* Please compile using: gcc -o prakashs_CS730 -O prakashs_CS730.c
********************************************************************************************/
